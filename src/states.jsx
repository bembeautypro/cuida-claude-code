...
import { Screen, ScreenHeader, Button, IconButton, Avatar } from './ui.jsx';
import {
  BrandMark,
  IconPlus, IconCamera, IconCheck, IconAlert, IconBox, IconChevR, IconClose,
} from './icons.jsx';
      ...
      <div style={{ padding: '0 20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <BrandMark size={44} style={{ color: 'var(--c-accent)' }}/>
          </div>
          ...
          <div style={{ marginTop: 20 }}>
            <Button variant="primary" size="md" icon={<IconPlus size={18}/>}>Criar primeiro perfil</Button>
          </div>
        </div>
      ...
      <div style={{ padding: '0 20px' }}>
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 22 }}>
            <Button variant="primary" size="md" icon={<IconCamera size={18}/>}>Por foto</Button>
            <Button variant="soft" size="md" icon={<IconPlus size={18}/>}>Manual</Button>
          </div>
        </div>
      </div>
    </Screen>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
            <button style={{
              ...
              <IconCheck size={16}/> Confirmar agora
            </button>
            <button style={{
              flex: 1, padding: '12px 16px', borderRadius: 12,
      ...
      <div style={{ padding: '0 20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <IconCheck size={42} stroke={2.5} style={{ color: '#fff' }}/>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {CUIDA_DATA.PROFILES.map((p, i) => (
            <div key={p.id} style={{
              display: 'flex', alignItems: 'center', gap: 12, padding: 12,
              borderRadius: 14, background: 'var(--c-card)', border: '1px solid var(--c-line)',
            }}>
              <Avatar name={p.name} color={p.color} fg={p.fg} size={36}/>
              <div style={{ flex: 1 }}>
              ...
              }}><IconCheck size={12} stroke={2.5}/> em dia</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <Screen hasTabBar={false}>
      <div style={{
        ...
        <div style={{
          ...
          <IconButton variant="soft" size={36} onClick={() => go && go('meds-v2')}><IconClose size={18}/></IconButton>
        ...
        <div style={{ padding: '6px 0 22px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 36 }}>
          <IconButton variant="soft" size={50}><IconCamera size={22}/></IconButton>
          <button onClick={() => go && go('med-detail')} style={{
            width: 76, height: 76, borderRadius: '50%',
            background: 'var(--c-accent-fg)', border: '4px solid var(--c-accent)',
            cursor: 'pointer',
          }}/>
          <IconButton variant="soft" size={50}><IconPlus size={22}/></IconButton>
        </div>
      </div>
    </Screen>
  );
