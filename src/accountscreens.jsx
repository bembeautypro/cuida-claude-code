  ...
  return (
    <Screen hasTabBar={false}>
      ...
      <div style={{ padding: '10px 20px 0' }}>
        <SoftCard background="var(--c-accent)" padding={20} radius={22}
            ...
            return (
              <button key={v} onClick={() => setCycle(v)} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  }}>{on && <IconCheck size={11} stroke={3} style={{ color: 'var(--c-accent-fg)' }}/>}</div>
                </div>
      ...
      <div style={{ padding: '22px 20px 0', display: 'flex', flexDirection: 'column', gap: 10 }}>
        <Button variant="primary" full size="lg">Salvar alterações</Button>
    ...
    <Screen hasTabBar={false}>
      ...
      <div style={{ padding: '22px 20px 0' }}>
        <div style={{
          ...
          <Button variant={copied ? 'success' : 'soft'} size="sm"
      ...
      <div style={{ padding: '12px 20px 0', display: 'flex', gap: 10 }}>
        <Button variant="primary" full icon={<IconWhatsApp size={18}/>}>WhatsApp</Button>
        <Button variant="outline" full icon={<IconShare size={18}/>}>Compartilhar</Button>
      </div>
  ...
  return (
    <Screen hasTabBar={false}>
      <div style={{ padding: '20px 28px 24px', display: 'flex', flexDirection: 'column', minHeight: '100%' }}>
        <IconButton variant="plain" size={36} onClick={() => go && go('login')}>
          <IconArrowL size={20}/>
        </IconButton>
        ...
        <button onClick={() => setAgree(a => !a)} style={{
          ...
          <div style={{
            ...
            display: 'grid', placeItems: 'center',
          }}>{agree && <IconCheck size={13} stroke={2.5} style={{ color: 'var(--c-accent-fg)' }}/>}</div>
...
export { PlanoScreen, IndicarScreen, SignupScreen, RecuperarSenhaScreen };
