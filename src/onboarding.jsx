...
import { CUIDA_DATA as D3 } from './data.jsx';
import { Screen, Button, IconButton, Avatar } from './ui.jsx';
import { EmergencyCardCarteirinha } from './screens.jsx';
import {
  BrandMark,
  IconCheck, IconArrowL, IconCamera, IconPlus, IconArrowR, IconChevD, IconChevR,
  IconWhatsApp, IconLink, IconChat,
} from './icons.jsx';
    ...
    <Screen hasTabBar={false}>
      <div style={{
        ...
        <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
          <BrandMark size={56} style={{ color: 'var(--c-accent)' }}/>
        ...
        <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 10 }}>
          <Button variant="primary" size="lg" full onClick={next}>Começar</Button>
          ...
          {options.map(o => {
            ...
            return (
              <button key={o.id} onClick={() => setPick(o.id)} style={{
                ...
                }}>{active && <IconCheck size={14} stroke={2.5}/>}</div>
              </button>
            );
          })}
        </div>
  ...
  return (
    <Screen hasTabBar={false}>
      ...
      <div style={{ padding: '0 24px' }}>
        ...
        <Button variant="outline" full icon={<IconPlus size={16}/>} size="sm">Adicionar manualmente</Button>
              ...
              <button onClick={() => setExpandedId(expandedId === med.id ? null : med.id)} style={{
                ...
                <div style={{
                  ...
                  {med.hasBox && <div style={{
                    ...
                    <IconCheck size={8} stroke={3} style={{ color: '#fff' }}/>
                  </div>}
                </div>
                <div style={{ flex: 1 }}>
      ...
      <div style={{ padding: '0 24px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex' }}>
            <Avatar name="A B" color="rgb(212, 232, 230)" size={40} style={{ marginRight: -10, border: '2px solid var(--c-surface)' }}/>
            <Avatar name="C D" color="rgb(254, 220, 195)" size={40} style={{ marginRight: -10, border: '2px solid var(--c-surface)' }}/>
            <Avatar name="E F" color="rgb(218, 235, 222)" size={40} style={{ border: '2px solid var(--c-surface)' }}/>
          </div>
        ...
        <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <InviteRow icon={<IconWhatsApp size={20}/>} label="Convidar pelo WhatsApp" detail="Link gerado automaticamente"/>
          <InviteRow icon={<IconLink size={20}/>} label="Copiar link de convite"/>
          <InviteRow icon={<IconChat size={20}/>} label="Outro app"/>
        </div>
  ...
  return (
    <Screen hasTabBar={false}>
      <div style={{ padding: '0 24px 24px' }}>
        ...
        <EmergencyCardCarteirinha profile={D3.PROFILES[0]}/>
...
function OnboardingNav({ step, total }) {
  return (
    <div style={{
      ...
      <IconButton variant="plain" size={36}>
        <IconArrowL size={20}/>
      </IconButton>
...
function OnboardingFooter({ onNext, nextLabel = 'Continuar', disabled }) {
  return (
    <div style={{
      ...
      <Button variant="primary" size="lg" full onClick={onNext} style={{ opacity: disabled ? .5 : 1 }}>
        {nextLabel}
      </Button>
    </div>
  );
